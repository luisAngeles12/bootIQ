            ...
            while (
                ...
                if (
                    ...
                    try:
                        ...
                        # antes de cerrar el websocket.
                        #
                        # on_close() también actualiza este flag,
                        # pero puede ejecutarse unas milésimas
                        # después de websocket.close(). Sin esta
                        # marca síncrona, otro get_candles() puede
                        # alcanzar a usar el socket ya cerrado.
