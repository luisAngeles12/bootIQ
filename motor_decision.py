...
def convertir_decision_v3_a_oficial(
    ...
    # ========================================================
    # D6.6 — RESCATE CORE4 DIRECTO
    # ========================================================
    #
    # Solo rescata señales que el V3 estadístico habría
    # rechazado, pero que pertenecen a patrones robustos
    # repetidos en dos OOS independientes.
    #
    # CORE4 + modo DIRECTA:
    #
    # OOS anterior:
    ...
    core4_r6 = (
        estrategia_core4
        in {
            "continuacion bajista con tendencia",
    ...
    if core4_directa:
        ...
        return {
            ...
            # La estadística V3 original no autorizó.
            # La autorización procede de una ruta OOS
            # específicamente validada.
            "directa_evidencia_solida": False,
            "directa_muestra": muestra,
            "directa_confiabilidad": confiabilidad,
            ...
            "motivo": (
                "D6.6: señal rechazada por la "
                "probabilidad histórica V3, pero "
                "rescatada por CORE4 DIRECTA, "
                "validado en dos OOS independientes. "
                + motivo_estadistico
            ).strip(),
        }
